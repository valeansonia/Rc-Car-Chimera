...
: ${AMENT_CURRENT_PREFIX:="/media/arrk-adas/RC-Env/RC-car-project/Rc-Car-Chimera/install/depth_sensing"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/depth_sensing/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/depth_sensing/environment/path.sh"
